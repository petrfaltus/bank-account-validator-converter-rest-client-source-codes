...
mkdir %OUT%
"%DOTNET_HOME%\csc.exe" /win32icon:%ICON% /out:%EXECUTABLE% /reference:%DLL% %SOURCE%.cs Web.cs RestRequest1.cs RestReply1.cs RestRequest2.cs RestReply2.cs DataLocalNumbering.cs
